package me.bingshanguxue.android.utils;
...
public class DataConvertUtil {
    ...
    static public String ByteArrToHex(byte[] inBytArr, String seperate)//字节数组转转hex字符串
    {
        StringBuilder strBuilder=new StringBuilder();
        int j=inBytArr.length;
        for (int i = 0; i < j; i++)
